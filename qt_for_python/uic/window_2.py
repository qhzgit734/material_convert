...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u9540\u950c\u8584\u94a2\u677f", None))
        self.label_D.setText(QCoreApplication.translate("Form", u"\u4ef7\u683c(\u5143/kg)", None))
        self.label_RES.setText(QCoreApplication.translate("Form", u"\u4ef7\u683c(\u5143/mm2)", None))
        self.label_XS.setText(QCoreApplication.translate("Form", u"\u7cfb\u6570(kg/mm2)", None))
        self.label.setText(QCoreApplication.translate("Form", u"\u578b\u53f7(mm)", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("Form", u"0.5", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Form", u"0.6", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("Form", u"0.75", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("Form", u"1", None))
        self.comboBox.setItemText(4, QCoreApplication.translate("Form", u"1.2", None))
        self.comboBox.setItemText(5, QCoreApplication.translate("Form", u"1.5", None))
        self.comboBox.setItemText(6, QCoreApplication.translate("Form", u"3", None))
